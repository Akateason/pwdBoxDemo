...
#define frameOffset  APP_HEIGHT * 0.6
#define offsetX      8.
...
- (void)presentationTransitionWillBegin
{
    ...
    [self.transitionCoordinator animateAlongsideTransition:^(id<UIViewControllerTransitionCoordinatorContext> context) {
        ...
        self.presentingViewController.view.transform = CGAffineTransformScale(self.presentingViewController.view.transform, 0.7, 0.7) ;
    } completion:nil] ;
}
...
- (CGRect)frameOfPresentedViewInContainerView
{
    ...
    CGRect frame2 = CGRectMake(frame1.origin.x + offsetX, frame1.origin.y + frameOffset, frame1.size.width - offsetX * 2 ,frame1.size.height - frameOffset);
